...
Using this code without any access from the author can lead to proh 
@*/
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px] bg-[#2a2a2a] text-white">
        ...
        <div className="grid grid-cols-3 gap-3">
          <Button onClick={() => signIn("google")} variant="outline" className="bg-[#3a3a3a] border-gray-600 hover:bg-[#4a4a4a]">
            <FaGoogle className="mr-2 h-4 w-4" /> Google
          </Button>
          <Button onClick={() => signIn("github")} variant="outline" className="bg-[#3a3a3a] border-gray-600 hover:bg-[#4a4a4a]">
            <FaGithub className="mr-2 h-4 w-4" /> GitHub
          </Button>
          <Button onClick={() => signIn("twitter")} variant="outline" className="bg-[#3a3a3a] border-gray-600 hover:bg-[#4a4a4a]">
